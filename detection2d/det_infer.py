...
def main():
    ...
    parser.add_argument('in_filename_csv', default=None, type=str, help="Path to the input data csv file")
    parser.add_argument('out_pred_cls_csv', default=None, type=str, help="Path to the predicted cls csv file")
    parser.add_argument('out_pred_loc_csv', default=None, type=str, help="Path to the predicted loc csv file")
    parser.add_argument('data_folder', default='', type=str, help='The folder containing images')
    parser.add_argument('model_folder', default='', type=str, help='The model folder')
    ...
    dataset_dev = ForeignObjectDataset(datafolder=args, datatype='dev', transform=data_transforms,
